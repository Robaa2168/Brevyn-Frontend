    ...
    return (
        <div className="footer-container bg-white shadow-md p-4 fixed bottom-0 inset-x-0 mt-10 md:hidden">
            <div className="footer-icons flex justify-around">
                {/* Home Icon */}
                <div className="icon home-icon text-emerald-500">
                    <FaHome size={20} />
                </div>

                {/* Dollar Icon */}
                <div className="icon wallet-icon text-emerald-500">
                    <FaDollarSign size={20} />
                </div>

                {/* Hand Holding Heart Icon */}
                <div className="icon volunteer-icon text-emerald-500">
                    <FaHandHoldingHeart size={20} />
                </div>

                {/* Notification Bell Icon */}
                <div className="relative icon notification-icon text-emerald-500" onClick={() => setShowNotifications(!showNotifications)}>
                    <FaBell size={24} />
                    {notificationCount > 0 && (

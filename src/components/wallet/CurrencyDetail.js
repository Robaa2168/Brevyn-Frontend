        ...
        <div className="container mx-auto p-4 bg-white rounded-lg shadow-md">
            ...
            <div className="border p-4 rounded-lg text-xs">
                ...
                <p className="mb-2">
                    Status:
                    <span
                        className={`inline-block ml-2 px-3 py-1 rounded-full text-xs font-medium ${currencyDetails?.isActive ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                            }`}
                    >
                ...
                >
                    {isActivating ? (
                        <>
                            ...
                            Activating {currencyDetails.currency}...
                        </>
                    ) : (
                        <>
                            <HiOutlineCheckCircle className="-ml-1 mr-2 h-3 w-3 text-current" /> {/* Display HiOutlineCheckCircle icon when not activating */}
                            Activate {currencyDetails.currency}
                        </>
                    )}
                </button>
